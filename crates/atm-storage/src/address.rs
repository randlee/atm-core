//! Canonical validated ATM agent address.
...
mod tests {
    ...
    use crate::types::{AgentName, HostName};

    #[test]
    fn constructor_rejects_host_without_team() {
        let agent = AgentName::from_validated("sender");
