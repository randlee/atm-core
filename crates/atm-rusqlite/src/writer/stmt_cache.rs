...
impl WriterStatementCache {
    pub(crate) fn insert_message_row<P: Params>(
        ...
        let mut statement = cached(
            connection,
            "INSERT INTO mail_messages(team, agent, message_key, envelope_json, from_agent, message_text, summary, message_at, message_id, parent_message_id, thread_mode, imported_from, recorded_at)
