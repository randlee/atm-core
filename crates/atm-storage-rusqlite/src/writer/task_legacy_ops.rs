//! Retained synchronous v1 task compatibility adapter.
//!
//! This module exists only for the 1.6.x coexistence bridge. Canonical v2
//! mutations live in task_ops; these functions preserve the previous
//! message-derived API until its separately approved removal.
