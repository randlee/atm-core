...
/// Builds the selector injected into every replacement daemon.
///
/// Startup has no hook-disable configuration surface: every durable new write
/// gets the selected receiver hook, including performance measurements.
