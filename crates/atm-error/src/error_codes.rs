...
pub enum AtmErrorCode {
    ...
    TemplateLoadFailed,
    TemplateHashApiFailed,
    /// The upstream template inspection parser rejected frontmatter or body/directive syntax.
    TemplateInspectionParseFailed,
    TemplateRequiredVariableMissing,
    TemplateRenderVerificationFailed,
    TemplateIncludeUnresolved,
    TemplateClassificationInvalid,
    ...
    WarningRosterDrift,
    /// Herdr exposes unnamed agents, so an ATM roster target cannot resolve.
    WarningHerdrUnnamedAgentTarget,
...
impl AtmErrorCode {
    ...
    fn mailbox_or_validation_str(self) -> Option<&'static str> {
        Some(match self {
            ...
            Self::TemplateLoadFailed => "TEMPLATE_LOAD_FAILED",
            Self::TemplateHashApiFailed => "TEMPLATE_HASH_API_FAILED",
            Self::TemplateInspectionParseFailed => "TEMPLATE_INSPECTION_PARSE_FAILED",
            Self::TemplateRequiredVariableMissing => "TEMPLATE_REQUIRED_VARIABLE_MISSING",
            Self::TemplateRenderVerificationFailed => "TEMPLATE_RENDER_VERIFICATION_FAILED",
            Self::TemplateIncludeUnresolved => "TEMPLATE_INCLUDE_UNRESOLVED",
            Self::TemplateClassificationInvalid => "TEMPLATE_CLASSIFICATION_INVALID",
    ...
    fn observability_or_warning_str(self) -> Option<&'static str> {
        Some(match self {
            ...
            Self::WarningHerdrUnnamedAgentTarget => "ATM_WARNING_HERDR_UNNAMED_AGENT_TARGET",
            ...
            Self::RosterNoLead => "ATM_ROSTER_NO_LEAD",
            Self::RosterMultipleLeads => "ATM_ROSTER_MULTIPLE_LEADS",
            Self::RosterReservedName => "ATM_ROSTER_RESERVED_NAME",
            Self::TaskStalled => "ATM_TASK_STALLED",
            Self::MemberBlocked => "ATM_MEMBER_BLOCKED",
...
fn parse_mailbox_or_validation_code(value: &str) -> Option<AtmErrorCode> {
    Some(match value {
        ...
        "TEMPLATE_LOAD_FAILED" => AtmErrorCode::TemplateLoadFailed,
        "TEMPLATE_HASH_API_FAILED" => AtmErrorCode::TemplateHashApiFailed,
        "TEMPLATE_INSPECTION_PARSE_FAILED" => AtmErrorCode::TemplateInspectionParseFailed,
        "TEMPLATE_REQUIRED_VARIABLE_MISSING" => AtmErrorCode::TemplateRequiredVariableMissing,
        "TEMPLATE_RENDER_VERIFICATION_FAILED" => AtmErrorCode::TemplateRenderVerificationFailed,
        "TEMPLATE_INCLUDE_UNRESOLVED" => AtmErrorCode::TemplateIncludeUnresolved,
        "TEMPLATE_CLASSIFICATION_INVALID" => AtmErrorCode::TemplateClassificationInvalid,
...
fn parse_observability_or_warning_code(value: &str) -> Option<AtmErrorCode> {
    Some(match value {
        ...
        "ATM_WARNING_HERDR_UNNAMED_AGENT_TARGET" => AtmErrorCode::WarningHerdrUnnamedAgentTarget,
        ...
        "ATM_ROSTER_NO_LEAD" => AtmErrorCode::RosterNoLead,
        "ATM_ROSTER_MULTIPLE_LEADS" => AtmErrorCode::RosterMultipleLeads,
        "ATM_ROSTER_RESERVED_NAME" => AtmErrorCode::RosterReservedName,
        "ATM_TASK_STALLED" => AtmErrorCode::TaskStalled,
        "ATM_MEMBER_BLOCKED" => AtmErrorCode::MemberBlocked,
