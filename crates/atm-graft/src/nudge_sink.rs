...
/// The Graft-side implementation of ATM's receiver notification contract.
///
/// This lives with the independently running Graft client. The daemon only
/// transmits the core hook envelope to the published receiver endpoint.
    ...
    fn emit_post_send(
        ...
        let PostSendBuiltInTarget::Graft(GraftNudgeTarget {
            ...
            return Err(AtmError::validation(
                "graft receive hook received a non-receiver target",
            ));
        };
