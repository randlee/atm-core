//! Deferred-nudge claim cleanup owned by the Herdr wake pump.
...
pub(crate) struct ReleasePendingOnDrop {
    ...
    /// Clears the member's ephemeral wake-pending flag after this claim
    /// attempt concludes, regardless of the exit path.
