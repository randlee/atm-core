...
//!
//! Cross-host delivery is one immediate ordinary singleton write followed by
//! confirmation for that message. Recovery must not reintroduce a sender-side
...
#[deprecated(note = "PeerResendScheduler was removed; there is no resend replacement")]
#[allow(dead_code)]
