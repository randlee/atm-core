...
/// Each worker owns one connection at a time; a rendezvous queue applies
/// backpressure before the daemon accumulates extra client file descriptors.
#[cfg(unix)]
const TCP_CONNECTION_WORKERS: usize = 96;
#[cfg(unix)]
