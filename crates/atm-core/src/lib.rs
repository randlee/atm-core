...
pub use boundary::{
    ...
    ConfigLoadRequest, ConfigLoadResponse, DoctorFinding, MailMessageState, MailStore,
    MailStoreBootstrapRequest, MailStoreBootstrapResponse, MailStoreDoctor, MailStoreDoctorReport,
    MailStoreHealthSnapshot, MailStoreIngestReplayState, MailStoreMailboxMetadataCounts,
    MailStoreMailboxMetadataRow, MailStoreMessageRecord, MessageFingerprint, MessageKey,
    NonClaudeOutbound, NonClaudeOutboundDeliveryRequest, NonClaudeOutboundDeliveryResponse,
    NotificationEvent, NotificationSink, ProjectionAppendMode, ReconcileCoordinator,
    ReconcileRequest, ReconcileResult, RemoteReplayStateRecord, RemoteReplayStore, ReplaySource,
    RequestDispatcher, RosterHarness, RosterMemberKind, RosterMemberRecord, RosterStore,
    RosterStoreDoctor, RosterStoreDoctorReport, RosterStoreHealthSnapshot, RuntimeBundle,
    RuntimeStatusSnapshot, RuntimeStorageFinalizer, ServerTransport, StatusSource, TaskState,
    TaskStore, TaskStoreAttachMessageLinkRequest, TaskStoreAttachMessageLinkResponse,
    ...
    roster_member_record_from_claude_code_member,
};
