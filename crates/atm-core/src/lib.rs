...
pub use boundary::{
    ...
    MailStoreBootstrapRequest, MailStoreBootstrapResponse, MailStoreDoctor,
    ...
    MessageFingerprint, MessageKey, NonClaudeOutbound, NonClaudeOutboundDeliveryRequest,
    NonClaudeOutboundDeliveryResponse, NotificationEvent, NotificationSink, ProjectionAppendMode,
    ReconcileCoordinator, ReconcileRequest, ReconcileResult, RemoteReplayStateRecord,
    RemoteReplayStore, ReplaySource, RequestDispatcher, RosterHarness, RosterMemberKind,
    RosterMemberRecord, RosterStore, RosterStoreDoctor, RosterStoreDoctorReport,
    RosterStoreHealthSnapshot, RuntimeBundle, RuntimeStatusSnapshot, RuntimeStorageFinalizer,
    ServerTransport, StatusSource, TaskState, TaskStore, TaskStoreAttachMessageLinkRequest,
