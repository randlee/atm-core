...
pub use boundary::{
    ...
    MailStoreLoadMessageRequest, MailStoreLoadMessageResponse, MailStoreMessageRecord,
    ...
    RosterStore, RosterStoreHealthSnapshot, RosterStoreHealthSnapshotRequest,
    ...
    RosterStoreRecordHeartbeatRequest, RosterStoreRecordHeartbeatResponse,
