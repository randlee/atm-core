# AQ2.7 QA-2 acceptance-test map
...
| 6 | `herdr_queue_wake::tests::ac06_retry_partition_has_a_bounded_release_side` | A stalled prompt requeues the exact claim and the next claim observes attempt 1. |
