...
| AQ2.5 | Queue delivery triggers: heartbeat producer (harness idle hooks), channel classifier, bare-CLI RAM FIFO + Stop-pull get (ADR-054 addendum) | must_follow AQ1, AQ1.7 · parallel_safe AQ2 |
