...
| 10 | restructure | Rand + fenix | (this commit) | REDRAFT | – | – | – | queue-first 5-sprint structure (AQ1 queue-cli, AQ2 graft, AQ3 tmux, AQ4 send-to core, AQ5 surface+evidence); all prior QA-hardened ACs preserved inside the consolidated docs; nudge/steer/queue taxonomy + repo-doc sweep folded in; re-review required |
