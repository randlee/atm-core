...
- D6a AY-QA-001 (blocking, phase gate): bump `HTTP_API_VERSION` once (minor) covering the additive wire changes of AY.3/AY.13/AY.14 and this sprint; state it in the PR body ADR-061 section.
