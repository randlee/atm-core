...
| --- | --- | --- | --- |
| `AD9-BLANKPANE-001` | `AD.9` | `AD.30` | accepted-line doctor/smoke evidence plus this readiness record |
| `ERRDOC-001` | `AD.9` | `AD.30` | accepted-line member/team-admin error-code evidence plus this readiness record |
