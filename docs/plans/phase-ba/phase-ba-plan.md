...
| BA.3 | `complete_task_handoff(runtime, member, head, now)` is the sole Start-write helper; BA.3 reminders and BA.5 head-task queue handoffs call it; head-only activation and failed-start retry tests |
