...
| AX.4 | B | after AX.3; **parallel with AX.1/AX.2** | Task completion and inspection CLI | Historical surface; use `atm task list` / `atm task events` (Phase BA), requirements §6.5/§6.6/§15.4, team-protocol, `docs/user-documents/tasks.md` | `sprint-AX.4-task-cli-and-docs.md` |
