...
| Cross-host/M5 | No MVP adapter exists in this proof subject | Not activatable under AL.9 as currently implemented | No listener/publisher may be invented for proof | N/A | Team-lead must assign a conforming non-TLS connector/endpoint or formally remove this requirement before closure |
