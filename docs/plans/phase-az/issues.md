...
| `AZ-TASK-CROSS-BINARY-COMPAT` | planned | Colima integration testbed | A retained 1.5.14 executable performs supported v1 task writes against a migrated ledger; a current binary observes the reconciled v2 state and audit trail. |
