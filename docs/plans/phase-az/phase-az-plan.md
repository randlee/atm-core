...
| --- | --- | --- | --- | --- |
| `AZ.1` | `complete` | `feature/az1-task-nudge-contract` | [`sprint-AZ.1-task-nudge-contract.md`](./sprint-AZ.1-task-nudge-contract.md) | bounded metadata-only nudge contract |
...
| `AZ.4` | `complete` | `feature/az4-attention-scheduler` | [`sprint-AZ.4-attention-scheduler.md`](./sprint-AZ.4-attention-scheduler.md) | fair one-item idle selector and persistent reminder lifecycle |
