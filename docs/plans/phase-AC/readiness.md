...
| `AC.1` | `planned` | `feature/pAC-s1-atm-storage-contract-and-canonical-types` | `../atm-core-worktrees/feature/pAC-s1-atm-storage-contract-and-canonical-types` | `crates/atm-storage` lands with a small audited message/roster contract, canonical domain structs, and separate notification traits |
