...
- `git diff --check`
- `rg -n "MailStore(Query|Transaction|Upsert|Load|Record|Request|Response)|RosterStore(Replace|Load|Query|List|Request|Response)" crates/atm-storage crates/atm-core/src/boundary -S`
