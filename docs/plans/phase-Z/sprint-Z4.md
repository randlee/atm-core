...
- `docs/plans/phase-Z/release-checklist.md` populated with the final executable
  validation and release checklist result
- `docs/plans/phase-Z/readiness.md` populated with the final release-ready /
  not-ready verdict and evidence

## Required Work

- fix only the findings promoted from `Z.3`
- only findings recorded in `docs/plans/phase-Z/canary-findings-ledger.md` are in
  ...
  marker in `docs/plans/phase-Z/canary-findings-ledger.md`
- rerun `docs/plans/phase-Z/release-checklist.md`
...
- every `Z.3` finding is either fixed or explicitly deferred with `team-lead`
  approval recorded in `docs/plans/phase-Z/canary-findings-ledger.md`
- no `Z.3` finding may remain in an undecided state before the release
  ...
  approval in `docs/plans/phase-Z/canary-findings-ledger.md`, and any missing
...
- `docs/plans/phase-Z/readiness.md` records the release-readiness verdict
- `docs/plans/phase-Z/readiness.md` `authorized_by` records an explicit named
...
- eligible `authorized_by` authorities are limited to `team-lead` by ATM
  ...
  equivalent named approval artifact in `docs/plans/phase-Z/readiness.md`
- `docs/plans/phase-Z/release-checklist.md` and `docs/plans/phase-Z/readiness.md`
