...
**Source**: user-mandated ack/send routing unification checklist, triaged
during the `feature/pAG-s15-othermac-smoke` cross-host smoke session
(2026-07-18). This case study is grounded in the phase-AG CROSSHOST-UNIFY
findings:

- `.triage/phase-AG/findings/CROSSHOST-UNIFY-1.ttl`
- `.triage/phase-AG/findings/CROSSHOST-UNIFY-3.ttl`
- `.triage/phase-AG/findings/CROSSHOST-UNIFY-4.ttl`
- `.triage/phase-AG/findings/CROSSHOST-UNIFY-5.ttl`
- `.triage/phase-AG/findings/CROSSHOST-UNIFY-7.ttl`

Those records cover the same leak family from different angles:
duplicated message-semantic pipelines, duplicated routing decisions,
duplicated inbound persistence logic, duplicated host matching, and
transport concerns leaking above the transport boundary.
...
See `docs/architecture/boundary/general-guidelines.md` for the general
