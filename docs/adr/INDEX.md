...
- [ADR-041 — End-To-End Peer Write Outcome (superseded by ADR-047)](./ADR-041-end-to-end-peer-write-outcome.md)
- ADR-047 — Direct trusted-LAN HTTP delivery (AK.4 decision; pending merge-forward)
