...
| `AA-ISSUE-005` | `open` | the repo still misclassifies the current Claude JSON-array inbox file shape as legacy in runtime/docs/smoke wording even though real `team-lead -> quality-mgr` traffic uses that current Claude path. | `AA.9` |
