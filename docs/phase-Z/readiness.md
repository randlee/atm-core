...
| Z.18 | `PENDING` | `PASS` | `complete` | smoke skill scaffold, canonical JSON contract, shared fixtures/helper layer, J2 report templates, tracked-latest `reports/smoke/` snapshots, and gitignored timestamped smoke artifacts now land without claiming fast/normal/thorough execution closure yet |
