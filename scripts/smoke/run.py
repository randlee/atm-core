    ...
    SuiteRowSpec(
        ...
        commands=[
            [
                ...
                "-p",
                "agent-team-mail-core",
                "protocol::tests::daemon_socket_path_ignores_atm_home",
                "--",
                "--exact",
            ],
            [
                ...
                "-p",
                "agent-team-mail-core",
                "protocol::tests::daemon_socket_path_rejects_override",
                "--",
                "--exact",
            ],
            [
    ...
    SuiteRowSpec(
        ...
        commands=[
            [
                ...
                "-p",
                "agent-team-mail",
                "composition::tests::resolve_command_runtime_context_reuses_atm_home_across_sibling_worktrees",
                "--",
                "--exact",
            ],
            [
                ...
                "-p",
                "agent-team-mail",
                "commands::members::tests::build_query_uses_command_invocation_dir_for_live_cwd",
                "--",
                "--exact",
            ],
            [
                ...
                "-p",
                "agent-team-mail",
                "commands::teams::tests::add_member_defaults_member_home_dir_to_command_invocation_dir",
                "--",
                "--exact",
            ],
        ],
