...
- status: `failed`
- timestamp: `2026-07-14T21:13:24.750076+00:00`
...
| `AD18-RUNTIME-ROOT-001` | shared-host raw CLI bootstrap reuses a single daemon and keeps runtime state under the accepted ATM_HOME root | `FAIL` | first failing command: /Library/Frameworks/Python.framework/Versions/3.11/bin/python3 scripts/smoke/run_thorough_shared_host.py |
...
- observed: {
  ...
  "exit_code": 1,
  "stdout": "",
  "stderr": "Traceback (most recent call last):\n  File \"/Users/randlee/Documents/github/atm-core-worktrees/smoke-test/1.3.1-cross-host/scripts/smoke/run_thorough_shared_host.py\", line 633, in <module>\n    raise SystemExit(main())\n                     ^^^^^^\n  File \"/Users/randlee/Documents/github/atm-core-worktrees/smoke-test/1.3.1-cross-host/scripts/smoke/run_thorough_shared_host.py\", line 302, in main\n    require_clean_host_daemon_state()\n  File \"/Users/randlee/Documents/github/atm-core-worktrees/smoke-test/1.3.1-cross-host/scripts/smoke/run_thorough_shared_host.py\", line 250, in require_clean_host_daemon_state\n    raise RuntimeError(\nRuntimeError: shared-host smoke requires an isolated OS user with no existing atm-daemon; refusing to attach to or terminate an ambient daemon"
}
...
- artifact: /Library/Frameworks/Python.framework/Versions/3.11/bin/python3 scripts/smoke/run_thorough_shared_host.py
