...
- status: `failed`
- timestamp: `2026-09-03T18:06:33.874097+00:00`
- binary SHA: `66af7870b319d066f418c3f166d72906aa133ddc`
- duration secs: `63.126`
- summary: `pass=29`, `fail=2`, `skip=0`
...
| `AD18-RUNTIME-ROOT-001` | shared-host raw CLI bootstrap reuses a single daemon and keeps runtime state under the accepted ATM_HOME root | `FAIL` | first failing command: /Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.7-atmbench/.bootstrap-venv/bin/python scripts/smoke/run_thorough_shared_host.py |
...
- observed: {
  "command": [
    "/Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.7-atmbench/.bootstrap-venv/bin/python",
    "scripts/smoke/run_thorough_shared_host.py"
  ],
  "exit_code": 1,
  "stdout": "",
  "stderr": "Traceback (most recent call last):\n  File \"/Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.7-atmbench/scripts/smoke/run_thorough_shared_host.py\", line 524, in <module>\n    raise SystemExit(main())\n                     ~~~~^^\n  File \"/Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.7-atmbench/scripts/smoke/run_thorough_shared_host.py\", line 234, in main\n    run_atm(root, shared_env_a, shared_a.workspace_dir, \"doctor\", \"--json\")\n    ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"/Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.7-atmbench/scripts/smoke/run_thorough_shared_host.py\", line 122, in run_atm\n    raise RuntimeError(json.dumps(completed, indent=2))\nRuntimeError: {\n  \"command\": [\n    \"/Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.7-atmbench/target/debug/atm\",\n    \"doctor\",\n    \"--json\"\n  ],\n  \"cwd\": \"/var/folders/2f/86pgbv3x6_9cplffpcg23kfc0000gp/T/z21s.6lxtjsrw/atm-a/w\",\n  \"exit_code\": 4,\n  \"stdout\": \"\",\n  \"stderr\": \"failed to inspect the Unix HTTP socket\\n  Recovery: Ensure atm-daemon binary is installed, then restore the single local daemon to a healthy serving state and retry.\"\n}"
}
- expected: all targeted validation commands exit 0
- likely root cause: one or more targeted Phase AD evidence checks regressed
- artifact: /Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.7-atmbench/.bootstrap-venv/bin/python scripts/smoke/run_thorough_shared_host.py
