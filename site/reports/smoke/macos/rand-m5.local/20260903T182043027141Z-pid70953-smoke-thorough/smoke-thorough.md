...
- status: `failed`
- timestamp: `2026-09-03T18:20:42.836181+00:00`
- binary SHA: `35594be3d1e6353421596fe275c9f62365e701bc`
- duration secs: `13.529`
...
- observed: {
  "command": [
    "/Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.8-atmbench/.bootstrap-venv/bin/python",
    "scripts/smoke/run_thorough_shared_host.py"
  ],
  "exit_code": 1,
  "stdout": "",
  "stderr": "Traceback (most recent call last):\n  File \"/Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.8-atmbench/scripts/smoke/run_thorough_shared_host.py\", line 524, in <module>\n    raise SystemExit(main())\n                     ~~~~^^\n  File \"/Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.8-atmbench/scripts/smoke/run_thorough_shared_host.py\", line 234, in main\n    run_atm(root, shared_env_a, shared_a.workspace_dir, \"doctor\", \"--json\")\n    ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"/Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.8-atmbench/scripts/smoke/run_thorough_shared_host.py\", line 122, in run_atm\n    raise RuntimeError(json.dumps(completed, indent=2))\nRuntimeError: {\n  \"command\": [\n    \"/Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.8-atmbench/target/debug/atm\",\n    \"doctor\",\n    \"--json\"\n  ],\n  \"cwd\": \"/var/folders/2f/86pgbv3x6_9cplffpcg23kfc0000gp/T/z21s.rtq0_r4g/atm-a/w\",\n  \"exit_code\": 4,\n  \"stdout\": \"\",\n  \"stderr\": \"failed to inspect the Unix HTTP socket\\n  Recovery: Ensure atm-daemon binary is installed, then restore the single local daemon to a healthy serving state and retry.\"\n}"
}
...
- artifact: /Users/atmbench/github/atm-core-worktrees/evidence/readiness-1.4.8-atmbench/.bootstrap-venv/bin/python scripts/smoke/run_thorough_shared_host.py
